...
class HandoverStageServiceTest {
    ...
    void setUp() {
        ...
        handoverStageService = new HandoverStageService(releaseCaseRepository, handoverStageRepository,
                recipientRepository, emailOutboxService, appProperties, permissionGuard, packageActionCompletionRepository);
