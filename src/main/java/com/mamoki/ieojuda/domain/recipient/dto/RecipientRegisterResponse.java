...
public record RecipientRegisterResponse(
        ...
        @Schema(description = "배정된 항목 ID") UUID itemId,
    ...
    public static RecipientRegisterResponse of(Recipient recipient, UUID itemId, boolean emailSent, String bounceType,
