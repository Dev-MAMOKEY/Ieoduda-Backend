...
8. **Repository가 5개뿐**(`User`, `Plan`, `LifeArea`, `LifeAreaMessage`, `Item`). 나머지 11개 엔티티(`Recipient`, `Confirmer`, `DisputeContact`, `Evidence`, `PartnerReviewer`, `ReleaseCase`, `Objection`, `Dependency`, `HandoverStage`, `AccessToken`, `PackageIssue`, `EmailLog`, `HandoffCheck`, `HandoffCheckResponse`, `Consent`)는 JPA 엔티티만 있고 Repository/Service/Controller가 아예 없음.
